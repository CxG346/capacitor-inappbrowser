...
| **`colorShareButton`**                 | <code>string</code>                                             |                                                                                                                                                                                   |                                                            |        |
| **`colorShareText`**                   | <code>string</code>                                             |                                                                                                                                                                                   |                                                            |        |
| **`colorTitle`**                       | <code>string</code>                                             |                                                                                                                                                                                   |                                                            |        |
| **`shareFunction`**                    | <code>boolean</code>                                            |                                                                                                                                                                                   |                                                            |        |
| **`printFunction`**                    | <code>boolean</code>                                            |                                                                                                                                                                                   |                                                            |        |
